...
//	',array': For slice types []byte, []int32, []int64 only: encodes them as TAG_ByteArray, TAG_IntArray,
//	          TAG_LongArray respectively instead of TAG_List. Also decodes those array tags back into the slice.
//	          (Without ',array', slices are always encoded as TAG_List. Arrays [...]byte/[...]int32/[...]int64
//	          continue to map to the array tags regardless of this flag.)
//	'name(,omitempty,array)': Encodes/decodes the field with a different name and optional flags. The order of
//	          'omitempty' and 'array' does not matter, e.g. 'Data,array,omitempty' is valid.
//
